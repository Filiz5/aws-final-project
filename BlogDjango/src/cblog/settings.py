...
DATABASES = {
    'default': {
        ...
        'NAME': 'fprds', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),#FinalProject2024!
        'HOST': 'fprds.cdaiqg202bit.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'xxxxxxxxxxxxxxxxxxxx' # please enter your s3 bucket name
